...
class CheckoutController extends Controller
{
    ...
    public function process(Request $request, $id)
    {
        ...
        session()->flash('success', 'You have successfully added a travel destination!');
    ...
    public function remove(Request $request, $detail_id)
    {
        ...
        session()->flash('success', 'You have successfully deleted your member!');
    ...
    public function create(Request $request, $id)
    {
        ...
        $transaction->save();
        session()->flash('success', 'You have successfully added your members for this tour!');
    ...
    public function success(Request $request, $id)
    {
        ...
        // setting configuration midtrans
