...
<body style="word-spacing:normal;background-color:#E4E6EB;">
    <div style="background-color:#E4E6EB;">
        ...
        <!--[if mso | IE]></td></tr></table><![endif]-->
        <!-- Paragraf Hi, Users & Transaction Detail -->
        <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
        <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                style="background:#ffffff;background-color:#ffffff;width:100%;">
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    <tbody>
                                        <tr>
                                            <td
                                                style="border-bottom:1px dashed #eee;vertical-align:middle;padding-bottom:20px;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    style="" width="100%">
                                                    <tbody>
                                                        <!-- Hi, Users -->
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    Hi, {{ $data->user->name }} <br /> <br /> Tiket
                                                                    digital kamu
                                                                    sudah berhasil dicetak. <br />
                                                                    Booking <strong>ID #{{ $data->id }}</strong></div>
                                                            </td>
                                                        </tr>
                                                        <!-- Member -->
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    border="0"
                                                                    style="color:#071C4D;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:25px;table-layout:auto;width:100%;border:none;">
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" bgcolor="#FF9E53"
                                                                            ...
                                                                            <a href="{{ url('checkout', $data->id) }}"
                                                                                style="display:inline-block;background:#FF9E53;color:#ffffff;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;">
                                                                                Check Details </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td colspan="2"
                                                            style="align: left; color: #071C4D; font-size: 18px; line-height: 20px; font-family: Assistant, Helvetica, Arial, sans-serif; padding-bottom: 13px;">
                                                            Butuh Bantuan? </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 50px;">
                                                        ...
                                                        <td
                                                            ...
                                                            support@traveefour.id <br /> 021-2021-2022 </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#6E6E6E;">
                                                    2021 Copyright Traveefour • All rights reserved • Made in Magelang
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
